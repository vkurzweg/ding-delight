...
class Nav extends React.Component { // eslint-disable-line react/prefer-stateless-function
  ...
  render() {
    const brand = <div style={{ display: 'inline-flex' }}>
                    ...
                    <A href="http://www.alohabrothers.surf" target="blank" style={{ fontFamily: 'Lobster', fontSize: '14px' }}>by Aloha Brothers <Image cloudName="kurzweg" publicId="aloha-logo" quality="auto" width="30" responsive  /></A>
                  </div>;

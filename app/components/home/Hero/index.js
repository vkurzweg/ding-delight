  ...
  return (
    <div>
      <div style={{ zIndex: '10', dispay: 'block', margin: '0 auto', width: '100%', position: 'absolute', marginTop: '20%' }}>
        <h1 style={{ fontSize: '56px', fontFamily: 'Lobster Two', fontWeight: 'bold', textAlign: 'center', color: '#2FF6CE', letterSpacing: '3px', marginBottom: '2%' }}>fast & fair local ding repair</h1>
        ...
        <h3 style={{ fontSize: '28px', fontFamily: 'Josefin Sans', textAlign: 'center', color: '#EB453A', textTransform: 'uppercase', letterSpacing: '3px' }}>same-day quote</h3>
      </div>
